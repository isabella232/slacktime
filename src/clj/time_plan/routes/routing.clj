(ns clj.time-plan.routes.routing
  (:require
    #_[time-plan.clj.member.member :refer [->tokens a]]
    ...
    [ring.util.response :refer [response]] [ring.util.request :as request]
...
(defstate client-config :start
  {:client-id     "2152829379.19546501478"
   :client-secret "ddf8c98eee0723855394ca4c30676570"
